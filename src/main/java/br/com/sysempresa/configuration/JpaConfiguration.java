package br.com.sysempresa.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.sysempresa.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "br.com.sysempresa.model" });
